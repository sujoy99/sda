    ...
    <div class="wrapper" style="min-height: 650px;">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled" id="list-unstyled">
                <!-- <p>Dummy Heading</p> -->
                <li>
                    <a class="nav-bar-actv-btn active-nav-bar-btn" href="./dashboard.php"><i
                            class="fa fa-tachometer-alt"></i><span style="margin-left: 8px;"></span>Dashboard</a>
                </li>
                <li>
                    ...
                    <form action="">
                        <div class="row" style="margin: 30px 0px 10px 0px;">
                            <div class="col-4 date-select-reconclsn text-center">
                                ...
                                <select name="date" id="date" class="chooseDate">
                                    ...
                                    for ($i = 0; $i < count($date); $i++) {
                                        ...
                                        echo "<option value='" . $date[$i]["PAY_DATE"] . "'>" . $date[$i]["PAY_DATE"] . "</option>";
                            }
